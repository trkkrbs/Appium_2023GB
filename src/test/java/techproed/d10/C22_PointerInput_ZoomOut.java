...
public class C22_PointerInput_ZoomOut extends VodQABaseTest {
    ...
    public void testZoomOut() {
        ...
        sequence1
                ...
                .addAction(finger1.createPointerMove(Duration.ofMillis(500), PointerInput.Origin.viewport(), 700, 1550))
                .addAction(finger1.createPointerUp(PointerInput.MouseButton.LEFT.asArg()));

        sequence2
                .addAction(finger2.createPointerMove(Duration.ofMillis(0), PointerInput.Origin.viewport(),1150, 1550))
