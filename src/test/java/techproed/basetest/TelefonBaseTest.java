...
//                .setUdid("emulator-5558"); // 2 cihaz calistirdigimizda calistiracagimiz cihazin UdId sini belirtmemiz lazim.
        ...
        UiAutomator2Options options = new UiAutomator2Options()
                .setAppPackage("com.android.dialer") // AppPackage & AppActivity ile de cihazimizi calistirabiliriz.
                .setAppActivity("com.android.dialer.main.impl.MainActivity"); // Boylece yukaridaki kod kalabaligindan kurtulmus oluruz.
