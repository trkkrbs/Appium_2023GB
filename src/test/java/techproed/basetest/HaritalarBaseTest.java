...
//                .setUdid("emulator-5558"); // 2 cihaz calistirdigimizda calistiracagimiz cihazin UdId sini belirtmemiz lazim.
        ...
        UiAutomator2Options options = new UiAutomator2Options()
                .setAppPackage("com.google.android.apps.maps") // AppPackage & AppActivity ile de cihazimizi calistirabiliriz.
                .setAppActivity("com.google.android.maps.MapsActivity"); // Boylece yukaridaki kod kalabaligindan kurtulmus oluruz.
