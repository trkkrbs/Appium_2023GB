...
//                .setUdid("emulator-5558"); // 2 cihaz calistirdigimizda calistiracagimiz cihazin UdId sini belirtmemiz lazim.
        ...
        UiAutomator2Options options = new UiAutomator2Options()
                .setAppPackage("com.mobisoft.kitapyurdu") // AppPackage & AppActivity ile de cihazimizi calistirabiliriz.
                .setAppActivity("com.mobisoft.kitapyurdu.main.SplashActivity"); // Boylece yukaridaki kod kalabaligindan kurtulmus oluruz.
